										...
										<tbody>
												...
												<c:forEach items="${sessionScope.alumnos}" var="x">
													<tr>
														...
														<td>${x.usuario.contraseña}</td>
														<td>
															<button type='button' data-toggle='modal' onclick="editar('${x.idalumno}','${x.nombre}','${x.dni}','${x.dni}','${x.direccion}','<fmt:formatDate value="${x.fecnac}" pattern="yyyy-MM-dd"/>');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
