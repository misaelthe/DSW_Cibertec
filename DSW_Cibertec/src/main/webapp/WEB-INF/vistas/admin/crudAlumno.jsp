...
<body>
	...
	<div class="container">
		...
		<div class="col-md-23">
			...
			<form accept-charset="UTF-8" action="filtrarAlumno"
				class="simple_form" id="defaultForm2" method="post">
				<div class="row" style="height: 70px">
					<div class="col-md-2">
						<input class="form-control" id="id_nonbre_filtro"
							name="nom_alumno" placeholder="Ingrese el nombre" type="text"
							maxlength="30" />
					</div>
					<div class="col-md-2">
										...
										<tr>
											...
											<td>
												<button type='button' data-toggle='modal'
													onclick="editar('${x.idalumno}','${x.nombre}','${x.dni}','${x.correo}','${x.direccion}','<fmt:formatDate value="${x.fecnac}" pattern="yyyy-MM-dd"/>','${x.telefono}','${x.usuario.idusuario}','${x.usuario.usuario}','${x.usuario.password}','${x.usuario.credencial}');"
				...
				<div class="modal-content">
					...
					<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_registra" accept-charset="UTF-8"
							action="registrarAlumno" class="form-horizontal" method="post">
									...
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#steps"
												href="#stepOne">Datos del Alumno</a>
										</h4>
									</div>
									...
									<div id="stepOne" class="panel-collapse collapse in">
										<div class="panel-body">
											<div class="form-group">
												...
												<div class="col-lg-5">
													<input class="form-control" id="ac_idalumno" readonly
			...
			<div class="modal-dialog" style="width: 60%">
				<div class="modal-content">
					<div class="modal-header" style="padding: 35px 50px">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4>
							<span class="glyphicon glyphicon-ok-sign"></span> Eliminar Alumno
						</h4>
					</div>
